...
import { saveSociete } from "../../repository/societeRepository";
...
function AjouterSociete() {
    ...
    const handleSubmit = (event) => {
        ...
        const user = { nom, email, adresse, telephone, matriculeFiscal, abonnementId, adminUserId };
        saveSociete(user).then((resp) => {
            console.log("resp.data soc", resp.data)
                        ...
                        <div className="card mb-3">
                            <div className="card-body">
                                <div className="pt-4 pb-2">
                                    <h5 className="card-title text-center pb-0 fs-4">Créez votre société</h5>
