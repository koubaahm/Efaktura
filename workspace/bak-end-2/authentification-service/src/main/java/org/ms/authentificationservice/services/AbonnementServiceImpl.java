...
public class AbonnementServiceImpl implements AbonnementService {
    ...
    public List<AbonnementResponseDTO> list() {
        ...
        for (Abonnement abonnement : abonnements) {
            ...
            if (abonnement.getSociete() != null) {
                ...
                abonnementResponseDTO.setNonSociete(abonnement.getSociete().getNom());
    ...
    @Override
    public AbonnementResponseDTO getAbonnementBySociete(Long idSociete) {
        Societe societe = societeRepository.findById(idSociete)
                .orElseThrow(() -> new EntityNotFoundException("Societe not found"));

        Abonnement abonnement = societe.getAbonnement();
        if (abonnement == null) {
            throw new EntityNotFoundException("Abonnement not found for the specified Societe");
        }
