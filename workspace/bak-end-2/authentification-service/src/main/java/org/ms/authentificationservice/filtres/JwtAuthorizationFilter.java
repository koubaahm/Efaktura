...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authorizationToken != null && authorizationToken.startsWith(PREFIXE_JWT)) {
            try {
                ...
                LocalDateTime dateFinAbonnement = obtenirDateFinAbonnement(userEmail);
                ...
                UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(userEmail, null, permissions);
    ...
    private LocalDateTime obtenirDateFinAbonnement(String userEmail) {
        AppUser appUser = appUserRepository.findByEmail(userEmail);
        if (appUser != null) {
