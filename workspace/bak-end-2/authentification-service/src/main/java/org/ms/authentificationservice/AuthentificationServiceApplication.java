...
import org.ms.authentificationservice.controllers.AbonnementRestController;
import org.ms.authentificationservice.controllers.AppRoleRestController;
import org.ms.authentificationservice.controllers.AppUserRestController;
import org.ms.authentificationservice.controllers.SocieteRestController;
...
public class AuthentificationServiceApplication {
	...
	@Bean
	CommandLineRunner start(AppUserRestController appUserRestController, AppRoleRestController appRoleRestController, SocieteRestController societeRestController, AbonnementRestController abonnementRestController, RepositoryRestConfiguration repositoryRestConfiguration,AppUserRepository appUserRepository) {
		repositoryRestConfiguration.exposeIdsFor(AppUser.class);
		return args -> {
//			// Créer un rôle
//			AppRoleRequestDTO appRoleRequestDTO = AppRoleRequestDTO.builder().rolename("SUPER ADMIN").build();
...
//			appUserRestController.addRoleToUser("koubaa", "SUPER ADMIN");
//			appUserRestController.addRoleToUser("mlik", "SUPER ADMIN");
...
//			appUserRestController.saveOperateur(user6);
