...
public class Facture {
    ...
    private double timbreFiscale =1000;
    ...
    public Facture(LocalDate date,  String modePaiement, String statut, String commentaires, List<LigneFacture> factureLignes, Client client,String numeroFacture) {
        this.date = date;
